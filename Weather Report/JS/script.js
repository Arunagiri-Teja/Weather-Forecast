...
const conutryTxt = document.querySelector('.country-txt')
...
const apiKey = 'db81c7feed909c2c2a4736ec09e39c6f'
...
conutryTxt.textContent = country
  ...
  showDisplaySection(weatherInfoSection)
    ...
    async function updateForecastsInfo(city) {
      ...
      forecastsData.list.forEach(forecastWeather => {
        if(forecastWeather.dt_txt.endsWith(timeTaken) && !forecastWeather.dt_txt.endsWith(todayDate)){
